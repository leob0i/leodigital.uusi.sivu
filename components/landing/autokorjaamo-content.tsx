      ...
      <section className="relative py-24 lg:py-32 border-t border-[#2a2a2a] overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-[auto_1fr] gap-6 lg:gap-16 items-start">
            {/* Leo's picture */}
            <div className="flex items-center gap-4 lg:block lg:w-[26rem] shrink-0">
              <div className="relative w-20 h-20 sm:w-24 sm:h-24 lg:w-[26rem] lg:h-auto lg:aspect-[4/5] rounded-2xl lg:rounded-3xl border border-[#2a2a2a] bg-[#111111]/60 backdrop-blur-xl overflow-hidden shrink-0">
                <Image
                  src="/images/leoprofiilikuva.jpeg"
                  alt="Leo Apell"
                  fill
                  sizes="(max-width: 1024px) 96px, 416px"
                  className="object-cover"
                />
                <div className="hidden lg:block absolute inset-0 bg-gradient-to-t from-[#111111] via-transparent to-transparent" />
                <div className="hidden lg:block absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-[#111111] to-transparent">
                  <h3 className="text-xl font-display text-[#f0f0f0]">Leo Apell</h3>
                  <p className="text-sm text-[#a0a0a0]">Perustaja & Omistaja</p>
                </div>
              </div>
              <div className="lg:hidden">
                <h3 className="text-lg font-display text-[#f0f0f0]">Leo Apell</h3>
                <p className="text-sm text-[#a0a0a0]">Perustaja & Omistaja</p>
              </div>
            </div>
